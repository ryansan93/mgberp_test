var pk = {
    ...
    settingUp: function() {
        ...
        $(div_action).find('select.karyawan').select2();
    ...
    loadForm: function(id, edit = null, href = null) {
        ...
        $.ajax({
            url : 'transaksi/PiutangKaryawan/loadForm',
            data : {
                'params' :  params,
                'edit' :  edit
            },
    ...
    getLists: function() {
        ...
        if ( err > 0 ) {
            ...
            $.ajax({
                url :'transaksi/PiutangKaryawan/getLists',
                dataType: 'html',
				type: 'get',
                data : {
                    'params': data
        ...
        if ( err > 0 ) {
            ...
            bootbox.confirm('Apakah anda yakin ingin menyimpan data ?', function(result) {
                if ( result ) {
                    ...
                    $.ajax({
                        url :'transaksi/PiutangKaryawan/save',
                        type : 'POST',
                        data : formData,
                        contentType : false,
                        processData : false,
                        ...
                        success : function(data){
                            ...
                            if ( data.status == 1 ) {
                                bootbox.alert(data.message, function(){
                                    pk.loadForm(data.content.id, null, 'action');
                                });
                            } else {
        ...
        if ( err > 0 ) {
            ...
            bootbox.confirm('Apakah anda yakin ingin meng-ubah data ?', function(result) {
                if ( result ) {
                    ...
                    $.ajax({
                        url :'transaksi/PiutangKaryawan/edit',
                        type : 'POST',
                        data : formData,
                        contentType : false,
                        processData : false,
    ...
    delete: function(elm) {
        bootbox.confirm('Apakah anda yakin ingin meng-hapus data ?', function(result) {
            if ( result ) {
                ...
                $.ajax({
                    url :'transaksi/PiutangKaryawan/delete',
                    type : 'POST',
                    dataType : 'JSON',
                    data : {
                        'params': data
