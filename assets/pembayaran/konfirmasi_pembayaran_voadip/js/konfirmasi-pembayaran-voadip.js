var kpv = {
  ...
  //       });
    ...
    load_form: function(elm, edit = null, href = null) {
        ...
        $.ajax({
            url : 'pembayaran/KonfirmasiPembayaranVoadip/load_form',
            data : {
                'params' :  params,
                'edit' :  edit
            },
    ...
    get_lists: function() {
        ...
        if ( err > 0 ) {
            ...
            $.ajax({
                url : 'pembayaran/KonfirmasiPembayaranVoadip/get_lists',
                data : { 'params': params },
                type : 'get',
                dataType : 'html',
	...
	get_data_voadip: function() {
        ...
        if ( err > 0 ) {
            ...
            $.ajax({
                url : 'pembayaran/KonfirmasiPembayaranVoadip/get_data_voadip',
                data : { 'params': params },
                type : 'get',
                dataType : 'html',
                beforeSend : function(){ showLoading() },
    ...
    submit: function(elm) {
        ...
        if ( detail.length == 0 ) {
            ...
            $.get('pembayaran/KonfirmasiPembayaranVoadip/konfirmasi_pembayaran',{
                'params': params
            },function(data){
                var _options = {
                    className : 'veryWidth',
        ...
        if ( err > 0 ) {
            ...
            bootbox.confirm('Apakah anda yakin ingin menyimpan data pembayaran ?', function(result) {
                if ( result ) {
                    ...
                    $.ajax({
                        url : 'pembayaran/KonfirmasiPembayaranVoadip/save',
                        data : { 'params': params },
                        type : 'POST',
                        dataType : 'JSON',
                        beforeSend : function(){ showLoading() },
                        success : function(data){
                            ...
                            if ( data.status == 1 ) {
                                bootbox.alert(data.message, function() {
                                    ...
                                    kpv.load_form($(btn), null, 'transaksi');
        ...
        if ( err > 0 ) {
            ...
            bootbox.confirm('Apakah anda yakin ingin meng-ubah data pembayaran ?', function(result) {
                if ( result ) {
                    ...
                    $.ajax({
                        url : 'pembayaran/KonfirmasiPembayaranVoadip/edit',
                        data : { 'params': params },
                        type : 'POST',
                        dataType : 'JSON',
                        beforeSend : function(){ showLoading() },
    ...
    delete: function(elm) {
        ...
        bootbox.confirm('Apakah anda yakin ingin meng-hapus data pembayaran ?', function(result) {
            if ( result ) {
                ...
                $.ajax({
                    url : 'pembayaran/KonfirmasiPembayaranVoadip/delete',
                    data : { 'params': params },
                    type : 'POST',
                    dataType : 'JSON',
                    beforeSend : function(){ showLoading() },
