var st = {
    ...
    getLists: function () {
		...
		if ( err > 0 ) {
			...
			$.ajax({
                url : 'report/SisaTagihanBakulPerTanggal/getLists',
                data : {
                    'params' : params
                },
                type : 'GET',
    ...
    encryptParams: function() {
		...
		if ( err > 0 ) {
			...
			$.ajax({
                url : 'report/SisaTagihanBakulPerTanggal/encryptParams',
                data : {
                    'params' : params
                },
                type : 'POST',
    ...
    exportExcel : function (params) {
		goToURL('report/SisaTagihanBakulPerTanggal/exportExcel/'+params);
	}, // end - exportExcel
};
