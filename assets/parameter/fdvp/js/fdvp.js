var fdvp = {
    ...
    getLists_Feed : function(keyword = null){
        $.ajax({
            ...
            type : 'GET',
            beforeSend : function(){
                App.showLoaderInContent($('table.tbl_feed tbody'));
            },
            success : function(data){
                App.hideLoaderInContent($('table.tbl_feed tbody'), data);
    ...
    getLists_Doc : function(keyword = null){
        $.ajax({
            ...
            type : 'GET',
            beforeSend : function(){
                App.showLoaderInContent($('table.tbl_doc tbody'));
            },
            success : function(data){
                App.hideLoaderInContent($('table.tbl_doc tbody'), data);
    ...
    getLists_Voadip : function(keyword = null){
        $.ajax({
            ...
            type : 'GET',
            beforeSend : function(){
                App.showLoaderInContent($('table.tbl_voadip tbody'));
            },
            success : function(data){
                App.hideLoaderInContent($('table.tbl_voadip tbody'), data);
    ...
    getLists_Peralatan : function(keyword = null){
        $.ajax({
            ...
            type : 'GET',
            beforeSend : function(){
                App.showLoaderInContent($('table.tbl_peralatan tbody'));
            },
            success : function(data){
                App.hideLoaderInContent($('table.tbl_peralatan tbody'), data);
