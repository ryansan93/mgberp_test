var feed = {
    ...
    changeTabActive: function(elm) {
        ...
        if ( vhref == 'action' ) {
            ...
            feed.load_form(v_id, tgl_mulai, resubmit);
        };
    }, // end - changeTabActive
    ...
    save : function() {
        ...
        if ( err > 0 ) {
            ...
            bootbox.confirm('Apakah anda yakin menyimpan harga pakan ?', function(result){
                if ( result ) {
                    ...
                    _data['pakan1'] = numeral.unformat($('input[name=pakan1]').val());
                    _data['pakan2'] = numeral.unformat($('input[name=pakan2]').val());
                    _data['pakan3'] = numeral.unformat($('input[name=pakan3]').val());
            ...
            success : function(data){
                ...
                if(data.status){
                    bootbox.alert(data.message,function(){
                        feed.getLists();
                        feed.load_form(data.content.id, data.content.tgl_mulai);
                    });
                }else{
    ...
    edit : function () {
        ...
        if ( err > 0 ) {
            ...
            bootbox.confirm('Apakah anda yakin mengubah harga pakan ?', function(result){
                if ( result ) {
                    var formData = new FormData();
                    var filename = null;
