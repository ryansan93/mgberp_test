<div class="row content-panel detailed">
	<div class="col-lg-12">
		...
		<div class="col-lg-9" style="padding-top: 2px;">
            ...
            <label class="" style="margin-bottom: 0px;">
                <input style="display: none;" placeholder="Dokumen" class="file_lampiran no-check" type="file" onchange="kp.showNameFile(this)" data-name="name" data-allowtypes="xlsx" data-required="1">
	...
	<div class="col-lg-12">
		<button type="button" class="btn btn-success" onclick="kp.download()"><i class="fa fa-download"></i> Download Contoh Excel</button>
	</div>
</div>