<div class="row content-panel detailed">
	<div class="col-lg-12">
		...
		<div class="col-lg-9" style="padding-top: 2px;">
            ...
            <label class="" style="margin-bottom: 0px;">
                <input style="display: none;" placeholder="Dokumen" class="file_lampiran no-check" type="file" onchange="ov.showNameFile(this)" data-name="name" data-allowtypes="xlsx" data-required="1">
                <i class="glyphicon glyphicon-paperclip cursor-p" title="Attachment"></i> 
            </label>
        </div>
        <div class="col-lg-2 no-padding">
        	<button type="button" class="btn btn-primary pull-right" onclick="ov.upload()"><i class="fa fa-upload"></i> Upload</button>
        </div>
	</div>
	<div class="col-lg-12">
		<hr>
	...
	<div class="col-lg-12">
		<button type="button" class="btn btn-success" onclick="ov.download()"><i class="fa fa-download"></i> Download Contoh Excel</button>
	</div>
</div>