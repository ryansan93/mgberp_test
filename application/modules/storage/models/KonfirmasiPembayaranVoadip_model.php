...
class KonfirmasiPembayaranVoadip_model extends Conf{
	protected $table = 'konfirmasi_pembayaran_voadip';

	protected $primaryKey = 'id';
	protected $nomor = 'nomor';
	protected $kodeTable = 'BYV';
	...
	{
		return $this->hasMany('\Model\Storage\KonfirmasiPembayaranVoadipDet_model', 'id_header', 'id')->with(['d_unit', 'detail']);
	}
