...
class KirimPakan_model extends Conf {
	// public $incrementing = false;
	// public $timestamps = false;

	protected $table = 'kirim_pakan';
	...
	{
		return $this->hasOne('\Model\Storage\TerimaPakan_model', 'id_kirim_pakan', 'id');
	}

	public function retur()
	{
		return $this->hasOne('\Model\Storage\ReturPakan_model', 'no_order', 'no_order');
	}

	public function detail()
	{
		return $this->hasMany('\Model\Storage\KirimPakanDetail_model', 'id_header', 'id')->orderBy('item', 'asc')->orderBy('jumlah', 'asc')->with(['d_barang']);
	}
