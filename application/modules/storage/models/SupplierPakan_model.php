...
class SupplierPakan_model extends Conf{
	protected $table = 'supplier_pakan';
	// protected $primaryKey = 'id';
	// protected $docNum = 'kode';
 //  	protected $status = 'g_status';

	public function data_supplier()
	{
		return $this->hasOne('\Model\Storage\Supplier_model', 'nomor', 'id_supl')->where('tipe', 'supplier')->where('jenis', '<>', 'ekspedisi')->orderBy('id', 'DESC');
	}

// 	public function getDashboard_Doc($status)
// 	{
