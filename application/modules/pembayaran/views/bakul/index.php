		...
		<form role="form" class="form-horizontal">
			<div class="panel-heading">
				<ul class="nav nav-tabs nav-justified" id="myTab" role="tablist">
					<li class="nav-item">
						<a class="nav-link <?php echo ( $rm == 0 ) ? 'active' : ''; ?>" data-toggle="tab" href="#history" data-tab="history" role="tab">Riwayat Pembayaran</a>
					</li>
					<li class="nav-item">
						<a class="nav-link <?php echo ( $rm == 1 ) ? 'active' : ''; ?>" data-toggle="tab" href="#action" data-tab="action" role="tab">Pembayaran</a>
					</li>
				</ul>
			</div>
			<div class="panel-body" style="padding-top: 0px; padding-bottom: 0px;">
				<div class="tab-content">
					<div id="history" class="tab-pane fade <?php echo ( $rm == 0 ) ? 'show active' : ''; ?>" role="tabpanel">
						<div class="col-lg-12 no-padding">
					...
					<div id="action" class="tab-pane fade <?php echo ( $rm == 1 ) ? 'show active' : ''; ?>" role="tabpanel">
						<?php echo $add_form; ?>
					</div>
				</div>
			</div>
