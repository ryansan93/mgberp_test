...
<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
	<button type="button" class="btn btn-primary col-xs-12" onclick="kpv.get_data_voadip()"><i class="fa fa-search"></i> Tampilkan</button>
</div>
...
<div class="col-xs-12 no-padding"><hr style="margin-top: 10px; margin-bottom: 10px;"></div>
<div class="col-xs-12 no-padding">
	<button type="button" class="btn btn-primary pull-right" onclick="kpv.submit(this)" data-id="<?php echo $data['id']; ?>"><i class="fa fa-check"></i> Submit Edit</button>
</div>