	...
	<div class="row detailed">
		...
		<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
			...
			<div class="col-lg-12 no-padding">
				...
				<label class="">
					<input type="file" onchange="showNameFile(this)" class="file_lampiran" placeholder="Bukti Rekening Keluar" data-allowtypes="pdf|PDF|jpg|JPG|jpeg|JPEG|png|PNG" style="display: none;">
		...
		<div class="col-md-12 no-padding" style="margin-top: 5px;">
	        ...
	        <div class="col-lg-12">
	            <div class="radio" style="margin-top: 0px;">
					<label><input type="radio" name="optradio" value="1" checked>Saldo Pelanggan</label>
				</div>
				<div class="radio" style="margin-bottom: 0px;">
					<label><input type="radio" name="optradio" value="0">Pengembalian Ke Rekening Pelanggan</label>
				</div>
	        </div>
		</div>
		...
		<div class="col-xs-12 no-padding">
			...
			<div class="col-xs-6 no-padding" style="padding-left: 5px;">
				<button type="button" class="col-xs-12 btn btn-primary" onclick="rt.saveRk()"><i class="fa fa-save"></i> Simpan</button>
			</div>
		</div>
	</div>
</div>