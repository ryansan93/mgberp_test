...
<div class="modal-body" style="padding-bottom: 0px;">
	<div class="row detailed">
		...
		<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
			<div class="col-xs-12 no-padding"><label class="control-label text-left">Pelanggan</label></div>
			<div class="col-xs-12 no-padding">
				<?php echo strtoupper($data['d_pelanggan']['nama']); ?>
			</div>
		</div>
		<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
		...
		<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
			<div class="col-xs-12 no-padding"><label class="control-label text-left">Jenis</label></div>
			<div class="col-xs-12 no-padding">
				<?php if ( $data['jenis'] == 1 ): ?>
					<?php echo 'Saldo Pelanggan'; ?>
				<?php else: ?>
					<?php echo 'Pengembalian Ke Rekening Pelanggan'; ?>
				<?php endif ?>
			</div>
		</div>
		...
		<div class="col-xs-12 no-padding">
			<div class="col-xs-6 no-padding" style="padding-right: 5px;">
				<button type="button" class="col-xs-12 btn btn-danger" data-dismiss="modal" onclick="rt.deleteRk(this)" data-kode="<?php echo $data['kode']; ?>"><i class="fa fa-trash"></i> Hapus</button>
			</div>
			<div class="col-xs-6 no-padding" style="padding-left: 5px;">
				<button type="button" class="col-xs-12 btn btn-primary" onclick="rt.editFormRk(this)" data-kode="<?php echo $data['kode']; ?>"><i class="fa fa-edit"></i> Edit</button>
			</div>
		</div>
	</div>
</div>