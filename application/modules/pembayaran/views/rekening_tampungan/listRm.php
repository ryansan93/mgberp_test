<?php if ( !empty($data) && count($data) > 0 ): ?>
	<?php foreach ($data as $k_data => $v_data): ?>
		<tr>
			...
			<td>
				<button type="button" class="col-xs-12 btn btn-primary" onclick="rt.viewFormRm(this)" data-kode="<?php echo $v_data['kode']; ?>" style="padding: 0px;"><i class="fa fa-file"></i></button>
			</td>
		</tr>
	<?php endforeach ?>
<?php else: ?>
