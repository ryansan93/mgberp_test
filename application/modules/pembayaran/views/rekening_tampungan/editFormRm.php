	...
	<div class="row detailed">
		...
		<div class="col-xs-12 no-padding">
			<div class="col-xs-6 no-padding" style="padding-right: 5px;">
				<button type="button" class="col-xs-12 btn btn-danger" onclick="rt.viewFormRm(this)" data-kode="<?php echo $data['kode']; ?>"><i class="fa fa-times"></i> Batal</button>
			</div>
			<div class="col-xs-6 no-padding" style="padding-left: 5px;">
				<button type="button" class="col-xs-12 btn btn-primary" onclick="rt.editRm(this)" data-kode="<?php echo $data['kode']; ?>"><i class="fa fa-save"></i> Simpan Perubahan</button>
			</div>
		</div>
	</div>
</div>