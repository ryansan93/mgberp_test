<form class="form-horizontal">
	<div class="col-xs-12 no-padding">
		<button id="btn-add" type="button" data-href="transaksi" class="btn btn-success cursor-p col-xs-12" title="ADD" onclick="kpd.changeTabActive(this)"> 
	...
	<div class="col-xs-6 no-padding" style="margin-bottom: 5px; padding: 0px 5px 0px 0px;">
		...
		<div class="col-xs-12 no-padding">
			...
			<select class="supplier" name="supplier[]" multiple="multiple" width="100%" data-required="1">
	...
	<div class="col-xs-12 no-padding" style="margin-top: 5px; margin-bottom: 5px;">
		<button id="btn-get-lists" type="button" class="btn btn-primary cursor-p col-xs-12" title="ADD" onclick="kpd.get_lists()"> 
