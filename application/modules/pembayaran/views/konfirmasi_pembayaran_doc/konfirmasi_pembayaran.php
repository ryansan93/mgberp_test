<div class="modal-header">
	<span class="modal-title"><b>KONFIRMASI PEMBAYARAN DOC</b></span>
			...
			<form role="form" class="form-horizontal">
				...
				<div class="col-xs-12 no-padding">
					<?php if ( !empty($data['nomor']) ): ?>
						<button type="button" class="btn btn-primary pull-right" onclick="kpd.edit(this)" data-id="<?php echo $data['id']; ?>"><i class="fa fa-save"></i> Simpan Perubahan</button>
					<?php else: ?>
						<button type="button" class="btn btn-primary pull-right" onclick="kpd.save()"><i class="fa fa-save"></i> Simpan</button>
					<?php endif ?>
				</div>
			</form>
		</div>
