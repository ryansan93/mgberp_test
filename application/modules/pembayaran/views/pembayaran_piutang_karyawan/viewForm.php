<div class="col-xs-12 no-padding">
    ...
    <div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
        <div class="col-xs-2 no-padding"><label class="label-control">Karyawam</label></div>
        <div class="col-xs-10 no-padding">
            <label class="label-control">: <?php echo strtoupper($data['nama_karyawan']); ?></label>
        </div>
    </div>
    <div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
    ...
    <div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
        ...
        <div class="col-xs-10 no-padding">
            <label class="label-control">: <?php echo ($data['jns_bayar'] == 'gaji') ? 'GAJI' : (($data['jns_bayar'] == 'perusahaan') ? 'PERUSAHAAN' : (($data['jns_bayar'] == 'bonus') ? 'BONUS' : 'NON GAJI')); ?></label>
        </div>
    </div>
    <div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
    ...
    <div class="col-xs-12 no-padding">
        <div class="col-xs-6 no-padding" style="padding-right: 5px;">
            <button type="button" class="col-xs-12 btn btn-danger" data-id="<?php echo $data['id']; ?>" onclick="ppk.delete(this)"><i class="fa fa-trash"></i> Hapus</button>
        </div>
        <div class="col-xs-6 no-padding" style="padding-left: 5px;">
            <button type="button" class="col-xs-12 btn btn-primary" data-id="<?php echo $data['id']; ?>" data-edit="edit" data-href="action" onclick="ppk.changeTabActive(this)"><i class="fa fa-edit"></i> Edit</button>
        </div>
    </div>
</div>