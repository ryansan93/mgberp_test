<?php if ( $akses['a_submit'] == 1 ): ?>
    <div class="col-xs-12 no-padding">
        <button id="btn-add" type="button" data-href="action" class="btn btn-success cursor-p col-xs-12" title="ADD" onclick="ppk.changeTabActive(this)"> 
...
<div class="col-xs-12 no-padding" style="margin-top: 5px; margin-bottom: 5px;">
    <button type="button" class="btn btn-primary col-xs-12" title="ADD" onclick="ppk.getLists()"> 
...
<small>
	...
	<table class="table table-bordered tbl_riwayat" style="margin-bottom: 0px;">
		<thead>
			<tr>
				<th class="col-xs-1">Kode Piutang</th>
