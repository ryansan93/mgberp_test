<?php if ( $akses['a_submit'] == 1 ): ?>
    <div class="col-xs-12 no-padding">
        <button id="btn-add" type="button" data-href="action" class="btn btn-success cursor-p col-xs-12" title="ADD" onclick="ppm.changeTabActive(this)"> 
...
<div class="col-xs-12 no-padding" style="margin-top: 5px; margin-bottom: 5px;">
    <button type="button" class="btn btn-primary col-xs-12" title="ADD" onclick="ppm.getLists()"> 
