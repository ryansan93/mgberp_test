<form class="form-horizontal">
	<div class="col-xs-12 no-padding">
		<button id="btn-add" type="button" data-href="transaksi" class="btn btn-success cursor-p col-xs-12" title="ADD" onclick="kpoap.changeTabActive(this)"> 
	...
	<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
		...
		<div class="col-xs-12 no-padding">
			...
			<select class="form-control perusahaan" multiple="multiple" width="100%" data-required="1">
				<option value="all">All</option>
	...
	<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
		...
		<div class="col-xs-12 no-padding">
			<select class="form-control ekspedisi" multiple="multiple" type="text" data-required="1">
				<option value="all" > All </option>
	...
	<div class="col-xs-12 no-padding" style="margin-top: 5px; margin-bottom: 5px;">
		<button id="btn-get-lists" type="button" class="btn btn-primary cursor-p col-xs-12" title="ADD" onclick="kpoap.getLists()"> 
	...
	<table class="table table-bordered tbl_riwayat" style="margin-bottom: 0px;">
		<thead>
			<tr>
				...
				<th class="col-xs-3">Ekspedisi</th>
