<div class="col-xs-12 no-padding">
    ...
    <div class="col-xs-12 no-padding"><hr style="margin-bottom: 10px;"></div>
    <div class="col-xs-12 no-padding">
        <button type="button" class="col-xs-12 btn btn-success pull-right tampilkan_riwayat" onclick="tb.tutupBulan()"><i class="fa fa-check"></i>TUTUP BULAN</button>
    </div>
</div>