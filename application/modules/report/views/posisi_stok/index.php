		...
		<form role="form" class="form-horizontal">
			<div class="col-lg-12 no-padding">
				<div class="col-lg-12 search left-inner-addon no-padding d-flex align-items-center" style="margin-bottom: 10px;">
					...
					<div class="col-sm-2">
						<button id="btn-tampil" type="button" data-href="action" class="btn btn-primary cursor-p pull-left" title="TAMPIL" onclick="ps.get_data()">Tampilkan</button>
					</div>
				</div>
				<div class="col-lg-12 search left-inner-addon no-padding d-flex align-items-center" style="margin-bottom: 10px;">
					<div class="col-sm-1 no-padding">
					...
					<div class="col-sm-2">
						<select class="form-control jns_barang">
						...
						<table class="table table-bordered tbl_list" style="margin-bottom: 0px;">
							<thead>
								<tr>
									...
									<th class="text-center col-lg-2">Kode Transaksi</th>
