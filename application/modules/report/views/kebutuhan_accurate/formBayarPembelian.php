<div class="col-xs-12 no-padding">
    <div class="col-xs-12 no-padding">
        ...
        <div class="col-xs-3 no-padding" style="padding-left: 5px; margin-bottom: 10px;">
            ...
            <div class="col-xs-12 no-padding">
                <select class="form-control jenis" multiple="multiple" data-required="1">
                    <option value="all">ALL</option>
        ...
        <div class="col-xs-12 no-padding">
            <button type="button" class="col-xs-12 btn btn-primary pull-right" onclick="ka.getLists(this)" data-jenis="8"><i class="fa fa-search"></i> Tampilkan</button>
        </div>
    </div>
</div>
            ...
            <table class="table table-bordered tbl_laporan" style="margin-bottom: 0px; max-width: 100%; width: 100%;">
                <thead>
                    <tr>
                        ...
                        <td colspan="4"></td>
                        <td class="total text-right" data-target="tagihan" data-jenis="decimal"><b>0</b></td>
                        <td class="total text-right" data-target="bayar" data-jenis="decimal"><b>0</b></td>
                        <td class="total text-right" data-target="pemotongan" data-jenis="decimal"><b>0</b></td>
                        <td class="total text-right" data-target="um" data-jenis="decimal"><b>0</b></td>
                        <td colspan="2"></td>
                    </tr>
                    <tr>
                        <th>DO</th>
                        ...
                        <th>Tagihan</th>
                        <th>Nominal Bayar</th>
                        <th>Nominal Pemotongan</th>
                        <th>Nominal UM Yang Digunakan</th>
                        <th>No. Bukti UM</th>
...
<div class="col-xs-12 no-padding"><hr style="margin-top: 10px; margin-bottom: 10px;"></div>
<div class="col-xs-12 no-padding">
    <button type="button" class="btn btn-default pull-right" onclick="ka.excryptParams(this)" data-tipe="excel" data-jenis="8"><i class="fa fa-file-excel-o"></i> Export Excel</button>
    <button type="button" class="btn btn-default pull-right" onclick="ka.excryptParams(this)" data-tipe="xml" data-jenis="8" style="margin-right: 10px;"><i class="fa fa-file-o"></i> Export XML</button>
</div>