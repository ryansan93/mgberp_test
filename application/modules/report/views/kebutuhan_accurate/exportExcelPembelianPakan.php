            ...
            <tbody>
                <?php if ( !empty($data) && count($data) > 0 ) { ?>
                    <?php foreach ($data as $key => $value) { ?>
                        <tr>
                            <td class="str"><?php echo 'PAKAN'; ?></td>
                            <td class=""><?php echo ($value['tanggal']); ?></td>
                            ...
                            <td class=""><?php echo !empty($value['tanggal_faktur']) ? ($value['tanggal_faktur']) : '-'; ?></td>
                            <td class=""><?php echo ($value['tanggal_pengiriman']); ?></td>
                            ...
                            <td class=""><?php echo ($value['tgl_terima']); ?></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
