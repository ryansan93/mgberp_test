                ...
                <?php if ( !empty($data) && count($data) > 0 ) { ?>
                    <?php foreach ($data as $key => $value) { ?>
                        <tr>
                            ...
                            <td class="decimal_number_format"><?php echo $value['kuantitas']; ?></td>
                            <td class="decimal_number_format"><?php echo round($value['harga_per_satuan_kuantitas'], 2); ?></td>
                            <td class="decimal_number_format"><?php echo round(($value['kuantitas'] * $value['harga_per_satuan_kuantitas']), 2); ?></td>
                            <td class=""><?php // echo strtoupper($value['unit'].'-'.$value['nama_plasma'].'-'.$value['kandang_plasma']); ?></td>
                            <td class=""><?php // echo $value['periode_chickin']; ?></td>
                            <td class=""><?php // echo strtoupper($value['unit'].'-'.$value['nama_plasma'].'-'.$value['kandang_plasma'].' Periode '.$value['periode_chickin']); ?></td>
                        </tr>
                    <?php } ?>
                <?php } else { ?>
                    <tr>
