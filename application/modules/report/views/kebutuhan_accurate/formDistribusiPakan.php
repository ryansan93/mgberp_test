<div class="col-xs-12 no-padding">
    <div class="col-xs-12 no-padding">
        ...
        <div class="col-xs-12 no-padding">
            <button type="button" class="col-xs-12 btn btn-primary pull-right" onclick="ka.getLists(this)" data-jenis="7"><i class="fa fa-search"></i> Tampilkan</button>
        </div>
    </div>
</div>
...
<div class="col-xs-12 no-padding">
    <div class="col-xs-12 no-padding" style="overflow-x: auto;">
        <small>
            <table class="table table-bordered tbl_laporan" style="margin-bottom: 0px; max-width: 150%; width: 150%;">
                <thead>
                    <tr>
...
<div class="col-xs-12 no-padding"><hr style="margin-top: 10px; margin-bottom: 10px;"></div>
<div class="col-xs-12 no-padding">
    <button type="button" class="btn btn-default pull-right" onclick="ka.excryptParams(this)" data-jenis="7"><i class="fa fa-file-excel-o"></i> Export Excel</button>
</div>
