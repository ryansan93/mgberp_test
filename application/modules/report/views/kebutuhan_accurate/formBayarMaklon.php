<div class="col-xs-12 no-padding">
    <div class="col-xs-12 no-padding">
        ...
        <div class="col-xs-12 no-padding">
            <button type="button" class="col-xs-12 btn btn-primary pull-right" onclick="ka.getLists(this)" data-jenis="10"><i class="fa fa-search"></i> Tampilkan</button>
        </div>
    </div>
</div>
...
<div class="col-xs-12 no-padding"><hr style="margin-top: 10px; margin-bottom: 10px;"></div>
<div class="col-xs-12 no-padding">
    <button type="button" class="btn btn-default pull-right" onclick="ka.excryptParams(this)" data-tipe="excel" data-jenis="10"><i class="fa fa-file-excel-o"></i> Export Excel</button>
    <button type="button" class="btn btn-default pull-right" onclick="ka.excryptParams(this)" data-tipe="xml" data-jenis="10" style="margin-right: 10px;"><i class="fa fa-file-o"></i> Export XML</button>
</div>