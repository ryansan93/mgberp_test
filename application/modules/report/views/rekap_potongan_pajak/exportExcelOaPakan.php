                    ...
                    <?php foreach ($data as $key => $value) { ?>
                        <?php foreach ($value['detail'] as $k_det => $v_det) { ?>
                            <tr class="cursor-p data">
                                ...
                                <td class="str"><?php echo strtoupper($v_det['no_ekspedisi']); ?></td>
                                <td class="str"><?php echo strtoupper($v_det['ekspedisi']); ?></td>
                                ...
                                <td class="text-right decimal_number_format"><?php echo $v_det['pdpt_belum_pajak']; ?></td>
                                ...
                                <td class="text-right decimal_number_format"><?php echo $v_det['pdpt_sudah_pajak']; ?></td>
                                <td class="text-right decimal_number_format"><?php echo $v_det['transfer']; ?></td>
                                <td class="str"><?php echo strtoupper($v_det['invoice']); ?></td>
                                <td class="str"><?php echo strtoupper($value['unit']); ?></td>
                                <td><?php echo strtoupper($v_det['tgl_bayar']); ?></td>
            ...
            <tbody>
                <?php if ( !empty($data) && count($data) > 0 ) { ?>
                    <?php foreach ($data as $key => $value) { ?>
                        <?php foreach ($value['detail'] as $k_det => $v_det) { ?>
                            <tr class="cursor-p data">
                                <td class="str"><?php echo strtoupper($v_det['nama_perusahaan']); ?></td>
                                <td class="str"><?php echo strtoupper($v_det['nama_ekspedisi']); ?></td>
                                <td class="str"><?php echo strtoupper($v_det['nama_npwp']); ?></td>
                                <td class="str"><?php echo strtoupper($v_det['npwp']); ?></td>
                                <td class="text-right decimal_number_format"><?php echo $v_det['sub_total']; ?></td>
                                <td class="text-right decimal_number_format"><?php echo $v_det['potongan_pph_23_prs']; ?></td>
                                <td class="text-right decimal_number_format"><?php echo $v_det['potongan_pph_23']; ?></td>
                                <td class="text-right decimal_number_format"><?php echo $v_det['total']; ?></td>
                                <td class="str"><?php echo $v_det['alamat']; ?></td>
                                <td class="str"><?php echo $v_det['no_telp']; ?></td>
                                <td class="str"><?php echo !empty($v_det['no_skb']) ? strtoupper($v_det['no_skb']) : '-'; ?></td>
                                <td class="str"><?php echo !empty($v_det['tgl_habis_skb']) ? strtoupper($v_det['tgl_habis_skb']) : '-'; ?></td>
                            </tr>
                        <?php } ?>
                    <?php } ?>
                <?php } else { ?>
