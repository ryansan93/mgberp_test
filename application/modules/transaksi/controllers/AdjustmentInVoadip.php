...
class AdjustmentInVoadip extends Public_Controller {

    private $path = 'transaksi/adjustment_in_voadip/';
    private $url;
    private $akses;
    ...
    public function index($segment=0)
    {
        if ( $this->akses['a_view'] == 1 ) {
            $this->add_external_js(array(
                ...
                "assets/transaksi/adjustment_in_voadip/js/adjustment-in-voadip.js",
            ));
            $this->add_external_css(array(
                "assets/select2/css/select2.min.css",
                "assets/transaksi/adjustment_in_voadip/css/adjustment-in-voadip.css",
            ));
            ...
            // Load Indexx
            $data['title_menu'] = 'Adjustment In OVK';
    ...
    public function save()
    {
        ...
        try {
            $m_adjin = new \Model\Storage\AdjinVoadip_model();
            $now = $m_adjin->getDate();
    ...
    public function hitungStokByTransaksi()
    {
        ...
        try {
            ...
            $sql = "EXEC hitung_stok_voadip_by_transaksi 'adjin_voadip', '".$id."', '".$tanggal."', ".$delete.", ".$status_jurnal."";
