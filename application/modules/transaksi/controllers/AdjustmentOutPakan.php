...
class AdjustmentOutPakan extends Public_Controller {

    private $path = 'transaksi/adjustment_out_pakan/';
    private $url;
    ...
    public function index($segment=0)
    {
        ...
        if ( $akses['a_view'] == 1 ) {
            $this->add_external_js(array(
                ...
                "assets/transaksi/adjustment_out_pakan/js/adjustment-out-pakan.js",
            ));
            $this->add_external_css(array(
                "assets/select2/css/select2.min.css",
                "assets/transaksi/adjustment_out_pakan/css/adjustment-out-pakan.css",
            ));
            ...
            // Load Indexx
            $data['title_menu'] = 'Adjustment Out Pakan';
    ...
    public function getSj()
    {
        ...
        try {
            $m_conf = new \Model\Storage\Conf();
            $sql = "
                select top 1 s.* from stok s where periode = '".$params['tgl_sj']."' order by s.periode desc
            ";
    ...
    public function hitungStokByTransaksi()
    {
        ...
        try {
            ...
            $sql = "EXEC hitung_stok_pakan_by_transaksi 'adjout_pakan', '".$id."', '".$tanggal."', ".$delete.", ".$status_jurnal."";
