<?php if ( !empty($data) && count($data) > 0 ): ?>
	<?php foreach ($data as $k => $v_data): ?>
		<tr class="search">
			...
			<td class="tujuan"><?php echo !empty($v_data['tujuan']) ? $v_data['tujuan'] : $v_data['jenis_tujuan']; ?></td>
			...
			<td>
				<!-- <div class="col-sm-4 no-padding text-center cursor-p btn_action">
					<i class="fa fa-edit" title="EDIT" data-id="<?php echo $v_data['id']; ?>" onclick="pp.changeTabActive(this)" data-href="pengiriman"></i>
				</div>
				<div class="col-sm-4 no-padding text-center cursor-p btn_action">
					<i class="fa fa-trash" title="DELETE" data-id="<?php echo $v_data['id']; ?>" onclick="pp.delete(this)"></i>
				</div> -->
				<div class="col-sm-6 no-padding text-center cursor-p btn_action">
					<i class="fa fa-file" title="VIEW" data-id="<?php echo $v_data['id']; ?>" onclick="pp.changeTabActive(this)" data-href="pengiriman"></i>
				</div>
				<div class="col-sm-6 no-padding text-center cursor-p btn_action">
