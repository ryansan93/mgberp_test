	...
	<div class="col-xs-12">
		...
		<div class="col-xs-12 no-padding">
			...
			<div class="col-xs-6 no-padding" style="margin-bottom: 5px;">
				<button type="button" class="btn btn-primary pull-left tambah_penerimaan" onclick="pp.change_tab(this)" data-id="" data-edit="" data-href="transaksi"><i class="fa fa-plus"></i> Tambah</button>
			</div>
			<div class="col-xs-6 no-padding" style="margin-bottom: 5px;">
				<button type="button" class="btn btn-primary pull-right tampilkan_riwayat" onclick="pp.list_riwayat(this)"><i class="fa fa-search"></i> Tampilkan</button>
			</div>
		</div>
	</div>
			...
			<table class="table table-bordered tbl_riwayat" style="margin-bottom: 0px;">
				<thead>
					<tr>
						...
						<!-- <th class="col-xs-3">Bayar</th>
						<th class="col-xs-3">Sisa Bayar</th>
