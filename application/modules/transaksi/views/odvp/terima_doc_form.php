		...
		<div class="col-lg-12 detailed">
			<form role="form" class="form-horizontal">
				<div class="form-group d-flex align-items-center">
					...
					<div class="col-lg-3">
						<input type="text" class="form-control no_sj" data-required="1" placeholder="NO. SJ">
					</div>
				...
				<div class="form-group d-flex align-items-center">
					...
					<div class="col-lg-3">
						<input type="text" class="form-control nopol" data-required="1" placeholder="NO. POLISI">
					</div>
				</div>
				<div class="form-group d-flex align-items-center">
				...
				<div class="form-group d-flex align-items-center">
					...
					<div class="col-lg-3">
						<input type="text" class="form-control kondisi" data-required="1" placeholder="KONDISI">
					</div>
					<div class="col-lg-2">Uniformity (%)</div>
					<div class="col-lg-3">
						<input type="text" class="form-control text-right uniformity" data-tipe="decimal" data-required="1" placeholder="UNIFORMITY" maxlength="6">
					</div>
				</div>
				<div class="form-group d-flex align-items-center">
					<div class="col-lg-3">Keterangan</div>
					<div class="col-lg-8">
						<textarea class="form-control ket" placeholder="KETERANGAN"></textarea>
					</div>
				</div>
