		...
		<div class="col-lg-12 detailed">
			...
			<form role="form" class="form-horizontal">
				<div class="form-group d-flex align-items-center">
					...
					<div class="col-lg-3">
						<input type="text" class="form-control no_sj" value="<?php echo $data_terima_doc['no_sj']; ?>" data-required="1" placeholder="NO. SJ">
					</div>
					<div class="col-lg-2" style="padding-top: 2px;">
						<a name="dokumen" class="text-right sj" href="<?php echo 'uploads/'.$data_terima_doc['path']; ?>" target="_blank" style="padding-right: 10px;"><i class="fa fa-file"></i></a>
						<label class="" style="margin-bottom: 0px;">
                        	<input style="display: none;" placeholder="Dokumen" class="file_lampiran_sj no-check" type="file" onchange="odvp.showNameFile(this)" data-name="no-name" data-allowtypes="doc|pdf|docx|jpg|jpeg|png">
				...
				<div class="form-group d-flex align-items-center">
					...
					<div class="col-lg-3">
						<input type="text" class="form-control nopol" value="<?php echo $data_terima_doc['nopol']; ?>" data-required="1" placeholder="NO. POLISI">
					</div>
				</div>
				<div class="form-group d-flex align-items-center">
				...
				<div class="form-group d-flex align-items-center">
					...
					<div class="col-lg-2">
						<input type="text" class="form-control text-right ekor" data-tipe="integer" maxlength="7" onblur="odvp.hit_box(this)" value="<?php echo angkaRibuan($data_terima_doc['jml_ekor']); ?>" data-required="1" placeholder="EKOR">
					</div>
					<div class="col-sm-1">Ekor</div>
					<div class="col-lg-2">
						<input type="text" class="form-control text-right box" data-tipe="integer" maxlength="5" readonly value="<?php echo angkaRibuan($data_terima_doc['jml_box']); ?>" data-required="1" placeholder="BOX">
					</div>
					<div class="col-sm-1">Box</div>
					<div class="col-lg-2">
						<input type="text" class="form-control text-right bb" data-tipe="decimal3" maxlength="7" value="<?php echo angkaDecimalFormat($data_terima_doc['bb'], 3); ?>" data-required="1" placeholder="BB">
					</div>
				...
				<div class="form-group d-flex align-items-center">
					...
					<div class="col-lg-3">
						<input type="text" class="form-control kondisi" value="<?php echo $data_terima_doc['kondisi']; ?>" data-required="1" placeholder="KONDISI">
					</div>
					<div class="col-lg-2">Uniformity (%)</div>
					<div class="col-lg-3">
						<input type="text" class="form-control text-right uniformity" data-tipe="decimal" data-required="1" placeholder="UNIFORMITY" value="<?php echo angkaDecimal($data_terima_doc['uniformity']); ?>" maxlength="6">
					</div>
				</div>
				<div class="form-group d-flex align-items-center">
					<div class="col-lg-3">Keterangan</div>
					<div class="col-lg-8">
						<textarea class="form-control ket" placeholder="KETERANGAN"><?php echo $data_terima_doc['keterangan']; ?></textarea>
					</div>
				</div>
