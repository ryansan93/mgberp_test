<div class="col-xs-12 no-padding">
    ...
    <div class="col-xs-12 no-padding">
        <div class="col-xs-6 no-padding" style="padding-right: 5px;">
            <button type="button" class="col-xs-12 btn btn-danger" data-id="<?php echo $data['id']; ?>" data-edit="" data-href="action" onclick="pk.changeTabActive(this)"><i class="fa fa-times"></i> Batal</button>
        </div>
        <div class="col-xs-6 no-padding" style="padding-left: 5px;">
            <button type="button" class="col-xs-12 btn btn-primary" data-id="<?php echo $data['id']; ?>" onclick="pk.edit(this)"><i class="fa fa-save"></i> Simpan Perubahan</button>
        </div>
    </div>
</div>