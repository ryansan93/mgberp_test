<div class="col-xs-12 no-padding">
    ...
    <div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
        <div class="col-xs-2 no-padding"><label class="label-control">Karyawan</label></div>
        <div class="col-xs-10 no-padding">
    ...
    <div class="col-xs-12 no-padding">
        <div class="col-xs-6 no-padding" style="padding-right: 5px;">
            <button type="button" class="col-xs-12 btn btn-danger" data-id="<?php echo $data['id']; ?>" onclick="pk.delete(this)"><i class="fa fa-trash"></i> Hapus</button>
        </div>
        <div class="col-xs-6 no-padding" style="padding-left: 5px;">
            <button type="button" class="col-xs-12 btn btn-primary" data-id="<?php echo $data['id']; ?>" data-edit="edit" data-href="action" onclick="pk.changeTabActive(this)"><i class="fa fa-edit"></i> Edit</button>
        </div>
    </div>
</div>