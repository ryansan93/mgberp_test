<div class="modal-header">
	<span class="modal-title"><b>EDIT PEMBAYARAN PERALATAN</b></span>
	...
	<div class="row detailed">
		<div class="col-lg-12 detailed">
			<form role="form" class="form-horizontal">
						...
						<table class="table table-bordered tbl_bayar" style="margin-bottom: 0px;">
							...
							<tbody>
								<tr class="baru belum_lunas">
									<td>
										<div class="col-xs-12 no-padding" style="padding-right: 5px;">
											<div class="input-group date datetimepicker tgl_bayar">
										        <input type="text" class="form-control text-center" placeholder="Tanggal" data-required="1" data-tgl="<?php echo $data['tgl_bayar']; ?>" />
									...
									<td>
										<input type="text" class="form-control text-right jml_bayar" data-tipe="decimal" data-required="1" placeholder="Jumlah" value="<?php echo angkaDecimal($data['total_bayar']); ?>">
									</td>
									<!-- <td></td> -->
								</tr>
							</tbody>
				...
				<div class="col-xs-12 no-padding">
					<button type="button" class="btn btn-primary pull-right" onclick="bpp.edit(this)" data-idbayar="<?php echo $data['id_bayar']; ?>"><i class="fa fa-save"></i> Simpan Perubahan</button>
				</div>
			</form>
		</div>
	</div>
