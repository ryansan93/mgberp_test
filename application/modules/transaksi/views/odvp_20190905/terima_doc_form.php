		...
		<div class="col-lg-12 detailed">
			<form role="form" class="form-horizontal">
				...
				<div class="form-group d-flex align-items-center">
					...
					<div class="col-lg-2">
						<input type="text" class="form-control text-right ekor" data-tipe="integer" maxlength="7" onblur="odvp.hit_box(this)" value="<?php echo angkaRibuan($data_order_doc['jml_ekor']); ?>" data-required="1">
					</div>
					<div class="col-sm-1">Ekor</div>
					<div class="col-lg-2">
						<input type="text" class="form-control text-right box" data-tipe="integer" maxlength="5" readonly value="<?php echo angkaRibuan($data_order_doc['jml_box']); ?>" data-required="1">
					</div>
