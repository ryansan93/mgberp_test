...
<div class="col-xs-12 no-padding" style="margin-bottom: 10px;">
	<div class="col-xs-4 no-padding" style="padding-right: 5px;">
		...
		<div class="col-xs-12 no-padding">
			<input type="text" class="form-control text-right hrg_beli" placeholder="Harga" data-tipe="decimal" onblur="aiv.hitHrgJual(this)">
		</div>
	</div>
	<div class="col-xs-4 no-padding" style="padding-left: 5px; padding-right: 5px;">
		...
		<div class="col-xs-12 no-padding">
			<input type="text" class="form-control text-right hrg_jual" placeholder="Harga" data-tipe="decimal" disabled>
		</div>
	</div>
