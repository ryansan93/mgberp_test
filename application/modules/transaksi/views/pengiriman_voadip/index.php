					...
					<div id="riwayat" class="tab-pane fade show active">
						<div class="col-lg-10 search no-padding d-flex align-items-center">
							...
							<div class="col-sm-3">
								...
								<button id="btn-add" type="button" data-href="pengiriman" class="btn btn-primary cursor-p pull-left" title="ADD" onclick="pv.changeTabActive(this)"><i class="fa fa-plus" aria-hidden="true"></i> ADD</button>
							</div>
							<div class="col-sm-2">
							</div>
						</div>
