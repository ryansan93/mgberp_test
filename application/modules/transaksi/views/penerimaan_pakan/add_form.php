...
<div class="form-group">
    <div class="col-lg-12 no-padding">
        <hr>
        <button id="btn-add" type="button" data-href="action" class="btn btn-primary cursor-p pull-left btn-action" title="ADD" onclick="pp.save_terima_pakan()" style="margin-left: 10px;"> 
