        ...
        <form role="form" class="form-horizontal">
            <div class="panel-heading">
                <ul class="nav nav-tabs nav-justified">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#penerimaan" data-tab="penerimaan">Penerimaan Pakan</a>
                    </li>
                </ul>
            </div>
                    ...
                    <div id="riwayat" class="tab-pane fade show active">
                        <div class="col-lg-10 search no-padding d-flex align-items-center">
                            ...
                            <div class="col-sm-3">
                                ...
                                <button id="btn-add" type="button" data-href="penerimaan" class="btn btn-primary cursor-p pull-left" title="ADD" onclick="pp.changeTabActive(this)"><i class="fa fa-plus" aria-hidden="true"></i> ADD</button>
                            </div>
                            <div class="col-sm-2">
                            </div>
                        </div>
            ...
            <!-- <div class="form-group d-flex align-items-center">
                <div class="col-lg-6 d-flex align-items-center no-padding">
                    ...
                    <div class="col-lg-6">
                        <select class="form-control no_sj" data-required="1" onchange="pp.get_data_by_sj(this)">
