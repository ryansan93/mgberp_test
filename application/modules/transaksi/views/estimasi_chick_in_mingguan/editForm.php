<div class="modal-header header">
	<span class="modal-title">Edit Estimasi Chick In Mingguan</span>
...
<div class="modal-body body">
    <div class="col-xs-12 no-padding">
                    ...
                    <select class="perusahaan" data-required="1">
                        ...
                        <?php if ( !empty( $perusahaan ) ) { ?>
                            <?php foreach ($perusahaan as $key => $value) { ?>
                                <?php
                                    $selected = null;
                                    if ( $value['kode'] == $data['kode_perusahaan'] ) {
                                        $selected = 'selected';
                                    }    
                                ?>
        ...
        <div class="col-xs-12 no-padding">
            ...
            <div class="col-xs-12 no-padding">
                <div class="col-xs-3 no-padding">
                    <input type="text" class="form-control text-right jumlah" data-tipe="integer" data-required="1" placeholder="Jumlah" maxlength="10" value="<?php echo angkaRibuan( $data['jumlah'] ); ?>">
                </div>
            </div>
        </div>
        <div class="col-xs-12 no-padding"><hr style="margin-top: 5px; margin-bottom: 5px;"></div>
        <div class="col-xs-12 no-padding">
            <button type="button" class="btn btn-primary col-xs-12" onclick="est.edit(this)" data-id="<?php echo $data['id']; ?>">
