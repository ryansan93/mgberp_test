					...
					<?php 
						...
						do { ?>
							...
							<tr class="child v-center <?php echo $inactive; ?>" data-key="<?php echo $_key ?>">
								...
								<!-- page 2 -->
								<td class="page2"><input class="form-control" type="text" name="program_kesehatan" value="<?php echo !isset($data_details[$_key][$index]['prokes']) ?: $data_details[$_key][$index]['prokes']; ?>" data-tipe="text"></td>
								<td class="page2"><input class="form-control" type="text" name="pengawas" value="<?php echo !isset($data_details[$_key][$index]['pengawas']) ?: $data_details[$_key][$index]['pengawas']; ?>" data-tipe="text"></td>
								<td class="page2"><input class="form-control" type="text" name="tim_sampling" value="<?php echo !isset($data_details[$_key][$index]['sampling']) ?: $data_details[$_key][$index]['sampling']; ?>" data-tipe="text"></td>
								<td class="page2">
								...
								<td class="page2"><input class="form-control" type="text" name="koordinator_area" value="<?php echo !isset($data_details[$_key][$index]['koar']) ?: $data_details[$_key][$index]['koar']; ?>" data-tipe="text"></td>
								...
								<td class="page2">
									<select class="form-control" name="formatPb">
										...
										<?php foreach ($perwakilan['parent']['formatPb'] as $format): ?>
											...
											?>
											<option value="<?php echo $format['id'] ?>" <?php echo $selected; ?> ><?php echo $format['format'] ?></option>
										<?php endforeach; ?>
									</select>
								</td>
