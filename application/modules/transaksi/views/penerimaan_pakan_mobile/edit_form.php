	...
	<div class="col-lg-12 detailed">
		...
		<form role="form" class="form-horizontal">
			...
			<div class="col-xs-12 no-padding" style="margin-bottom: 5px;">
				...
				<div class="col-xs-12 no-padding">
					<select id="select_no_sj" data-placeholder="Pilih No. SJ" class="form-control selectpicker" data-live-search="true" type="text" data-required="1" data-val="<?php echo $data['no_sj']; ?>" data-old="<?php echo $data['no_sj']; ?>" disabled>
	...
	<div class="col-lg-12 detailed">
		<form role="form" class="form-horizontal">
			<div class="col-xs-6 no-padding" style="padding-right: 5px;">
				<button type="button" class="btn btn-primary pull-right col-xs-12 btn-action" onclick="ppm.edit(this)"><i class="fa fa-save"></i> Simpan Perubahan</button>
			</div>
			<div class="col-xs-6 no-padding" style="padding-left: 5px;">
				<button type="button" class="btn btn-danger pull-right col-xs-12 btn-action" onclick="ppm.change_tab(this)" data-id="<?php echo $data['no_sj']; ?>" data-noreg="<?php echo $data['noreg']; ?>" data-nomor="<?php echo $data['nomor']; ?>" data-edit="" data-href="transaksi"><i class="fa fa-times"></i> Batal</button>
			</div>
		</form>
	</div>
</div>
