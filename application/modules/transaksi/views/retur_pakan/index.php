		...
		<form role="form" class="form-horizontal">
			<div class="panel-heading">
				<ul class="nav nav-tabs nav-justified">
					<li class="nav-item">
						<a class="nav-link active" data-toggle="tab" href="#riwayat_rp" data-tab="riwayat_rp">Riwayat Retur Pakan</a>
					</li>
					<li class="nav-item">
						<a class="nav-link" data-toggle="tab" href="#rp" data-tab="rp">Retur Pakan</a>
					</li>
				</ul>
			</div>
			<div class="panel-body">
				<div class="tab-content">
					<div id="riwayat_rp" class="tab-pane fade show active">
						<div class="col-lg-10 search no-padding d-flex align-items-center">
                            ...
                            <div class="col-sm-3">
                                <button id="btn-tampil" type="button" data-href="action" class="btn btn-primary cursor-p pull-left" title="TAMPIL" onclick="rp.get_lists()" style="margin-right: 10px;">Tampilkan</button>
                                <button id="btn-add" type="button" data-href="rp" class="btn btn-primary cursor-p pull-left" title="ADD" onclick="rp.changeTabActive(this)"><i class="fa fa-plus" aria-hidden="true"></i> ADD</button>
                            </div>
                            <div class="col-sm-2">
                            </div>
                        </div>
                        <div class="col-lg-2 action no-padding">
                            <div class="col-lg-12 search left-inner-addon no-padding pull-right" style="margin-left: 10px;">
                                <i class="glyphicon glyphicon-search"></i><input class="form-control" type="search" data-table="tbl_rp" placeholder="Search" onkeyup="filter_all(this)">
                            </div>
                        </div>
						...
						<div class="col-lg-4 action no-padding">
							<?php if ( $akses['a_submit'] == 1 ) { ?>
								<button id="btn-add" type="button" data-href="rp" class="btn btn-primary cursor-p pull-right" title="ADD" onclick="rp.changeTabActive(this)"> 
						...
						<small>
							<table class="table table-bordered tbl_rp" id="dataTable" width="100%" cellspacing="0">
								<thead>
									<tr>
