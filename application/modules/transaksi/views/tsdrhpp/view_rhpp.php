	               	...
	               	<div class="form-group align-items-center <?php echo $hide_plasma; ?>">
	                	<div class="col-sm-12">
		                	...
		                	<div class="col-md-2">
		                		...
		                		?>
		                		<input type="text" class="form-control text-right biaya_materai" value="<?php echo $data['biaya_materai']; ?>" data-tipe="integer" data-required="1" onblur="tsdrhpp.hit_tot_pengeluaran(this)" maxlength="7">
		                	</div>
	                	</div>
	                </div>
	               	<div class="form-group align-items-center <?php echo $hide_plasma; ?>">
	                	<div class="col-sm-12">
		                	...
		                	<div class="col-md-2">
		                		<input type="text" class="form-control text-right populasi_bonus_insentif_listrik" value="<?php echo $data['populasi_bonus_insentif_listrik']; ?>" data-tipe="integer" data-required="1" onblur="tsdrhpp.hit_bonus_insentif_listrik(this)" maxlength="7">
		                	</div>
	                	</div>
	                </div>
	            <?php else: ?>
	            			...
	            			<div class="col-sm-12 no-padding <?php echo $hide_inti; ?>">
	            				<?php if ( $data['cn'] == '' ): ?>
				            		<div class="col-sm-12 d-flex align-items-center">
				            			...
				            			<div class="col-sm-3">
				            				<input type="text" class="form-control text-right nilai_cn" data-tipe="decimal" placeholder="Nilai CN" onblur="tsdrhpp.setCn(this)" data-required="1">
				            			</div>
										<div class="col-sm-2 no-padding text-right"><label class="control-label">BIAYA OPR : </label></div>
				            			<div class="col-sm-4">
				            				<input type="text" class="form-control text-right nilai_opr" data-tipe="decimal" placeholder="Nilai OPR" onblur="tsdrhpp.setCn(this)" data-required="1">
				            			</div>
				            			<div class="col-sm-2">
				            				<button type="button" class="btn btn-primary" onclick="tsdrhpp.submitCn(this)" data-noreg="<?php echo $data['noreg']; ?>" data-id="<?php echo $data['id'] ?>">Submit CN & Biaya OPR</button>
				            			</div>
				            		</div>	            					
	            				<?php endif ?>
	            			</div>
            ...
            <fieldset>
	        	<div class="panel-heading no-padding">
					<ul class="nav nav-tabs nav-justified">
						...
						<li class="nav-item" style="<?php echo $style_hide_inti; ?>">
														...
														<?php else: ?>
															<?php if ( !empty($data_plasma['detail']['data_bonus']) ): ?>
																<?php foreach ($data_plasma['detail']['data_bonus'] as $k_db => $v_db): ?>
																	<tr class="bonus">
																		<td class="col-sm-5 kiri kanan keterangan"><?php echo $v_db['keterangan']; ?></td>
																		<td class="col-sm-4 text-right kanan jumlah_tagihan">
				            	...
				            	<div class="form-group">
						            <div class="col-sm-12" style="padding-left: 0px; padding-right: 0px;">
										<fieldset>
											...
											<small>
												<table class="table table-bordered tbl-piutang" style="margin-bottom: 0px;">
													<thead>
														<tr>
															<td class="col-sm-2"><b>Perusahaan</b></td>
															<td class="col-sm-1"><b>Tanggal</b></td>
															<td class="col-sm-1"><b>Kode</b></td>
															<td class="col-sm-4"><b>Keterangan</b></td>
															<td class="col-sm-2"><b>Sisa Hutang (Rp.)</b></td>
															<td class="col-sm-2"><b>Bayar (Rp.)</b></td>
														</tr>
													</thead>
													<tbody>
														<?php if ( isset($data_plasma['detail']['data_piutang_plasma']) && !empty($data_plasma['detail']['data_piutang_plasma']) ) { ?>
															<?php foreach ($data_plasma['detail']['data_piutang_plasma'] as $k_dpp => $v_dpp) { ?>
																<tr class="data">
																	<td class="nama_perusahaan"><?php echo strtoupper($v_dpp['nama_perusahaan']); ?></td>
																	<td><?php echo strtoupper(tglIndonesia($v_dpp['tanggal'], '-', ' ')); ?></td>
																	<td class="kode"><?php echo strtoupper($v_dpp['kode']); ?></td>
																	<td><?php echo strtoupper($v_dpp['keterangan']); ?></td>
																	<td class="text-right sisa_piutang"><?php echo angkaDecimal($v_dpp['sisa_piutang']); ?></td>
																	<td class="text-right">
																		<?php if ( $data['tutup_siklus'] == 1 ): ?>
																			<?php 
																				echo angkaDecimal( $v_dpp['nominal'] );
																				$tot_bayar_hutang += $v_dpp['nominal']; 
																			?>
																		<?php else : ?>
																			<input type="text" class="form-control text-right nominal" data-tipe="decimal" data-required="1" value="<?php echo angkaDecimal(0); ?>" onblur="tsdrhpp.hit_tot_bayar_hutang(this)">
																		<?php endif ?>
																	</td>
																</tr>
																<?php $tot_hutang += $v_dpp['sisa_piutang']; ?>
															<?php } ?>
															<tr class="tot_piutang">
																<td colspan="4" class="text-right"><b>TOTAL</b></td>
																<td class="text-right tot_hutang"><b><?php echo angkaDecimal($tot_hutang); ?></b></td>
																<td class="text-right tot_bayar_hutang"><b><?php echo angkaDecimal($tot_bayar_hutang); ?></b></td>
															</tr>
														<?php } else { ?>
															<tr class="non-data">
												...
												<table class="table table-bordered tbl-piutang" style="margin-bottom: 0px;">
													...
													<tbody>
														<?php if ( isset($data_plasma['detail']['data_piutang_plasma']) && !empty($data_plasma['detail']['data_piutang_plasma']) ) { ?>
															<?php foreach ($data_plasma['detail']['data_piutang_plasma'] as $k_dpp => $v_dpp) { ?>
																<tr>
																	<td><?php echo strtoupper($v_dpp['nama_perusahaan']); ?></td>
																	<td><?php echo strtoupper(tglIndonesia($v_dpp['tanggal'], '-', ' ')); ?></td>
																	<td><?php echo strtoupper($v_dpp['kode']); ?></td>
																	<td><?php echo strtoupper($v_dpp['keterangan']); ?></td>
																	<td class="text-right"><?php echo angkaDecimal($v_dpp['sisa_piutang']); ?></td>
																	<td>
																		<input type="text" class="form-control text-right nominal" data-tipe="decimal" data-required="1" value="<?php echo angkaDecimal(0); ?>">
																	</td>
																</tr>
															<?php } ?>
														<?php } else { ?>
							            	...
							            	<table class="table table-nobordered" style="margin-bottom: 0px;">
							            		<tbody>
							            			...
							            			<tr>
							            				...
							            				<td class="col-sm-4 text-right" style="padding-bottom: 0px;"><b><?php echo angkaRibuan($harga_rata_ayam); ?></b></td>
							            			</tr>
							            			<tr>
							            				...
							            				<td class="col-sm-4 text-right" style="padding-bottom: 0px;"><b><?php echo angkaRibuan($modal_inti); ?></b></td>
							            			</tr>
							            			<tr>
							            				<td class="col-sm-8 text-left" style="padding-bottom: 0px;"><b>Modal Inti Sebenarnya</b></td>
							            				<?php 
							            					$modal_inti_sebenarnya = ($total_pengeluaran > 0 && $total_tonase > 0) ? ($total_pengeluaran - $total_nilai_insentif) / $total_tonase : 0;
							            				?>
