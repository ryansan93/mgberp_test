<div class="modal-header">
	<span class="modal-title"><b>List Aktifitas Penerimaan Voadip</b></span>
		...
		<div class="col-lg-12 detailed">
			<form role="form" class="form-horizontal">
				...
				<div class="col-md-12 no-padding">
					...
					<div class="col-lg-9 no-padding action">
						<label class="control-label"><?php echo $data['tgl_terima']; ?></label>
					</div>
				</div>
				...
				<div class="col-md-12 no-padding">
					...
					<div class="col-lg-9 no-padding action">
						<label class="control-label"><?php echo $data['nopol']; ?></label>
					</div>
				</div>
