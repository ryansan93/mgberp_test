...
<div class="col-xs-12 no-padding">
	...
	<div class="col-xs-6 no-padding" style="padding-left: 5px;">
		...
		<div class="col-xs-12 no-padding">
			<button type="button" class="btn btn-primary" onclick="aop.getSj()"><i class="fa fa-search"></i> Tampilkan SJ</button>
		</div>
	</div>
</div>
...
<div class="col-xs-12 no-padding" style="margin-bottom: 10px;">
	...
	<div class="col-xs-4 no-padding" style="padding-left: 5px;">
		...
		<div class="col-xs-12 no-padding">
			<input type="text" class="form-control text-right jumlah" placeholder="Jumlah" data-tipe="decimal" data-required="1" onblur="aop.cekJumlahAdjust(this)">
		</div>
	</div>
</div>
<div class="col-xs-12 no-padding" style="margin-bottom: 10px;">
...
<div class="col-xs-12 no-padding"><hr style="margin-top: 10px; margin-bottom: 10px;"></div>
<div class="col-xs-12 no-padding">
	<button type="button" class="col-xs-12 btn btn-primary" onclick="aop.save()"><i class="fa fa-save"></i> Simpan</button>
</div>