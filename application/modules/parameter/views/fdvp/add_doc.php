<tr class="row_data">
	<td>
		<input class="form-control" type="text" id="kategori" data-required="1">
	</td>
	<td>
		<input class="form-control" type="text" id="kode" readonly>
	</td>
	<td>
		<input class="form-control" type="text" id="nama_doc" data-required="1">
	</td>
	<td>
	...
	<td>
		<input class="form-control text-right" type="text" id="berat" data-required="1" data-tipe="decimal">
	</td>
	<td>
		<input class="form-control text-right" type="text" id="isi" data-required="1" data-tipe="integer">
	</td>
	<td>
