<div id="form_status">
    <form class="form-horizontal" role="form">
    	<input type="hidden" name="nomor_supplier" data-nomor="<?php echo $data_detail->nomor; ?>">
    	<div class="form-group">
    		<label class="col-sm-4 text-right">Nama Supplier : </label>
    	...
    	<div class="form-group">
    		...
    		<div class="col-sm-6 padding-top-5">
    			<label id="file_nonaktif" data-idnama="<?php // echo $data_detail['lampiran_nonaktif']['id']; ?>">
        			<input type="file" required="required" onchange="showNameFile(this)" class="file_lampiran" data-required="1" name="nonaktif_lampiran" data-allowtypes="doc|pdf|docx|jpg|jpeg|png" style="display: none;" placeholder="Lampiran Non Aktif">
