<div class="panel-body no-padding">
	<div class="padding-left-15">
		<?php if ($akses['ack']): ?>
			<button id="ack_pelanggan" class="btn btn-primary" onclick="PLG.ack()">Ack</button>
		<?php endif; ?>
	</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<select class="form-control" name="jenis_plg">
										<option <?php if ($data['jenis'] == 'internal') : echo 'selected'; endif ?> value="internal">Internal</option>
										<option <?php if ($data['jenis'] == 'eksternal') : echo 'selected'; endif ?> value="eksternal">Eksternal</option>
									</select>
								</div>
							</div>
							<div class="form-group">
								...
								<div class="col-sm-4">
									<table class="table table-borderless">
										<tbody>
											...
											<tr>
												<td>
													<input required="required" class="form-control" type="text" name="telp_plg" data-tipe="phone" placeholder="Telepon" value="<?php echo $telp['nomor']; ?>">
												</td>
												<td>
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<select required="required" class="form-control" onchange="PLG.getListLokasi(this, '#alamat_pelanggan', 'kab', '')" name="propinsi_plg" placeholder="Propinsi KTP">
										...
										<?php foreach ($list_provinsi as $p): ?>
											<option <?php if ($lokasi['prov_id'] == $p['id']) : echo 'selected'; endif ?> value="<?php echo $p['id'] ?>"><?php echo $p['nama'] ?></option>
										<?php endforeach; ?>
									</select>
								</div>
								<div class="col-sm-4">
							...
							<div class="form-group">
								...
								<div class="col-sm-3">
									<select required="required" class="form-control" onchange="PLG.getListLokasi(this, '#alamat_pelanggan', 'kec', '')" name="kabupaten_plg" placeholder="Kab/Kota KTP">
										<option <?php if ($lokasi['kota_id'] == $p['id']) : echo 'selected'; endif ?>  disabled="" selected="selected" hidden="hidden">Pilih Kab/Kota</option>
									</select>
								</div>
							</div>
							<div class="form-group">
