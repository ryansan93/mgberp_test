<div class="modal-header header" style="padding-top: 0px;">
	<span class="modal-title">Add Nekropsi</span>
...
<div class="modal-body body" style="padding-bottom: 0px;">
	<div class="row">
		...
		<div class="col-lg-12 no-padding">
			<div class="col-lg-12">
				<button type="button" class="btn btn-primary cursor-p pull-right" onclick="nekropsi.save();"><i class="fa fa-save"></i> Simpan</button>
			</div>
		</div>
	</div>
</div>