<div class="modal-header header" style="padding-top: 0px;">
	<span class="modal-title">Edit Nekropsi</span>
...
<div class="modal-body body" style="padding-bottom: 0px;">
	<div class="row">
		<div class="col-lg-12 no-padding" style="padding-bottom: 0px;">
			<div class="col-lg-12">
				<label class="control-label">Keterangan Nekropsi</label>
			</div>
			<div class="col-lg-12">
		...
		<div class="col-lg-12 no-padding">
			<div class="col-lg-12">
				<button type="button" class="btn btn-primary cursor-p pull-right" onclick="nekropsi.edit(this);" data-id="<?php echo $data['id'] ?>"><i class="fa fa-edit"></i> Update</button>
			</div>
		</div>
	</div>
</div>