<div class="row content-panel">
	<div class="col-lg-12">
		<div class="col-lg-8 search left-inner-addon no-padding">
			<i class="glyphicon glyphicon-search"></i><input class="form-control" type="search" data-table="tbl_skp" placeholder="Search" onkeyup="filter_all(this)">
		</div>
		<div class="col-lg-4 action no-padding">
			<?php if ( $akses['a_submit'] == 1 ) { ?>
				<button id="btn-add" type="button" data-href="skp" class="btn btn-primary cursor-p pull-right" title="ADD" onclick="skp.add_form(this)"> 
	...
	<div class="col-lg-12 data">
		<small>
			<table class="table table-bordered tbl_skp">
				<thead>
					<tr>
						<th class="col-md-1">Nomor</th>
						<th class="col-md-2">Peternak</th>
						<th class="col-md-1">Mulai</th>
						<th class="col-md-1">Berakhir</th>
